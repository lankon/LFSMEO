...
namespace BurnInTester.Logic
{
    ...
    {
        public MainTask(IServiceProvider serviceProvider, IBurnInTesterMachine burnInTesterMachine, IF_StateControl f_StateControl)
        {
            Machine = burnInTesterMachine;
        ...
        private IBurnInTesterMachine Machine;
