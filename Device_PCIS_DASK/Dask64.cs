...
public delegate void CallbackDelegate64();
...
public class DASK64
{
    ...
    public const ushort PCIe_9524 = 51;
    public const ushort PCIe_9101 = 52;
    public const ushort PCIe_9121 = 53;
    public const ushort PCIe_9141 = 54;
    public const ushort PCIe_9103 = 55;
    public const ushort PCIe_9146 = 56;
    public const ushort PCIe_9147 = 57;
    public const ushort PCIe_9126 = 58;
    public const ushort PCIe_9161 = 59;
    public const ushort PCIe_9163 = 60;
    public const ushort PCIe_9164 = 61;
    public const ushort PCIe_7350_SPI = 62;
    public const ushort PCIe_7350_PARALLEL = 63;
...
//Error Number
    ...
    public const short ErrorAnaTriggerLevel       = -68;
    public const short ErrorInvalidDIOMode        = -69;
...
/* 20191205, added for pci-9116 calibration */
    public const short ErrorInvalidRefVoltage     = -325;
    public const short ErrorCalibrateFailed       = -326;
    public const short ErrorInvalidCalData        = -327;
    public const short ErrorFlashProgramTimeout   = -343;
    public const short ErrorInvalidFlashAddress   = -344;
    public const short ErrorFlashProgramVerify    = -345;

    public const short ErrorNullPoint                   = -398;
    public const short ErrorAccessViolationDataCopy     = -399;
//AD Range
   ...
   //Clock Mode
    ...
    public const ushort VoltLevel_DisableDO   = 3;
...
/* 20191205, added for pci-9116 calibration */
    public const ushort PCI9116_FLASH_USER_CALIBRATION_BLOCK           = 0x0000;
    public const ushort PCI9116_FLASH_VENDOR_CALIBRATION_BLOCK         = 0x0100; /* bit-8 */

/* Unipolar: Gain x1, x2, x4 and x8 */
    public const ushort PCI9116_CALIBRATION_UNIPOLAR_10_V         = 0;
    public const ushort PCI9116_CALIBRATION_UNIPOLAR_5_V          = 1;
    public const ushort PCI9116_CALIBRATION_UNIPOLAR_2_5_V        = 2;
    public const ushort PCI9116_CALIBRATION_UNIPOLAR_1_25_V       = 3;
/* Bipolar: Gain x1, x2, x4 and x8 */
    public const ushort PCI9116_CALIBRATION_BIPOLAR_5_V           = 4;
    public const ushort PCI9116_CALIBRATION_BIPOLAR_2_5_V         = 5;
    public const ushort PCI9116_CALIBRATION_BIPOLAR_1_25_V        = 6;
    public const ushort PCI9116_CALIBRATION_BIPOLAR_0_625_V       = 7;

    public const ushort PCI9116_CALIBRATION_MODE_MAX              = 8;
    public const ushort PCI9116_CALIBRATION_SETTING_MAX           = 16;

    public const ushort PCI9116_Cal_Op_Offset                     = 0;
    public const ushort PCI9116_Cal_Op_Gain                       = 1;
...
//Trigger Mode
    ...
    public const ushort P9812_AIEvent_Manual = 0x80;   //Middle Trigger Mode
...
//General Purpose Timer/Counter for 9221, PCIe-91xx
//Counter Mode
    ...
    public const ushort EdgeSeparationMSR         = 0x09;	// 91xx not support	
    public const ushort SingleTrigContPulseGenPWM = 0x0a;
    public const ushort ContGatedPulseGenPWM      = 0x0b;
    public const ushort CW_CCW_Encoder            = 0x0c;	// 91xx not support
    public const ushort x1_AB_Phase_Encoder       = 0x0d;	// 91xx not support
    public const ushort x2_AB_Phase_Encoder       = 0x0e;	// 91xx not support
    public const ushort x4_AB_Phase_Encoder       = 0x0f;	// 91xx not support
    public const ushort Phase_Z                   = 0x10;	// 91xx not support
    public const ushort OnFlyChange_PulseCounters = 0x81;   //2016/10/19

    /*Encoder Setting Event Mode*/
    public const ushort P91xx_EVT_MOD_EPT          = 0x00;
    /*Encoder Setting Event Control*/
    public const ushort P91xx_EPT_PULWIDTH_200ns    =0x00;
    public const ushort P91xx_EPT_PULWIDTH_2ms     = 0x01;
    public const ushort P91xx_EPT_PULWIDTH_20ms    = 0x02;
    public const ushort P91xx_EPT_PULWIDTH_200ms   = 0x03;
    public const ushort P91xx_EPT_TRGOUT_GPO        =0x04;
    public const ushort P91xx_EPT_TRGOUT_CALLBACK  = 0x08;
    /*Event Type*/
    public const ushort P91xx_EVT_TYPE_EPT0        = 0x00;
    public const ushort P91xx_EVT_TYPE_EPT1        = 0x01;
    ...
    public const ushort GPTC_UPDOWN_Ext           = 0x04;	// 91xx not support
...
//GPTC clock polarity
    ...
    public const ushort GPTC_EZ0_ClearPhase0      = 0x0;	// 91xx not support
    public const ushort GPTC_EZ0_ClearPhase1      = 0x1;	// 91xx not support
    public const ushort GPTC_EZ0_ClearPhase2      = 0x2;	// 91xx not support
    public const ushort GPTC_EZ0_ClearPhase3      = 0x3;	// 91xx not support

    public const ushort GPTC_EZ0_ClearMode0       = 0x0;	// 91xx not support
    public const ushort GPTC_EZ0_ClearMode1       = 0x1;	// 91xx not support
    public const ushort GPTC_EZ0_ClearMode2       = 0x2;	// 91xx not support
    public const ushort GPTC_EZ0_clearMode3       = 0x3;	// 91xx not support
...
/* AI Monitor Config*/
    public const ushort P9524_Monitor_AboveHigh   = 0;
    public const ushort P9524_Monitor_BelowLow    = 1;
    public const ushort P9524_Monitor_Rising      = 2;
    public const ushort P9524_Monitor_Falling     = 3;
//Counter Op
...
//Encoder constant
    ...
    /*------------------*/
    	/*Sampling Mode*/
	public const ushort MODE_MULT  = 0;
	public const ushort MODE_SIMU  = 1;
        /*Input Type*/
    public const ushort P91xx_AI_SingEnded        = 0x00;
    public const ushort P91xx_AI_Differential     = 0x80;
    public const ushort P91xx_CH0                 = 0x0;
    public const ushort P91xx_CH1                 = 0x1;
    public const ushort P91xx_CH2                 = 0x2;
    public const ushort P91xx_CH3                 = 0x3;
    public const ushort P91xx_CH4                 = 0x4;
    public const ushort P91xx_CH5                 = 0x5;
    public const ushort P91xx_CH6                 = 0x6;
    public const ushort P91xx_CH7                 = 0x7;
    public const ushort P91xx_CH8                 = 0x8;
    public const ushort P91xx_CH9                 = 0x9;
    public const ushort P91xx_CH10                = 0xa;
    public const ushort P91xx_CH11                = 0xb;
    public const ushort P91xx_CH12                = 0xc;
    public const ushort P91xx_CH13                = 0xd;
    public const ushort P91xx_CH14                = 0xe;
    public const ushort P91xx_CH15                = 0xf;
/*For 9103, PCIe-9161*/
    public const ushort P91xx_CH16 = 0x10;
    public const ushort P91xx_CH17 = 0x11;
    public const ushort P91xx_CH18 = 0x12;
    public const ushort P91xx_CH19 = 0x13;
    public const ushort P91xx_CH20 = 0x14;
    public const ushort P91xx_CH21 = 0x15;
    public const ushort P91xx_CH22 = 0x16;
    public const ushort P91xx_CH23 = 0x17;
    public const ushort P91xx_CH24 = 0x18;
    public const ushort P91xx_CH25 = 0x19;
    public const ushort P91xx_CH26 = 0x1a;
    public const ushort P91xx_CH27 = 0x1b;
    public const ushort P91xx_CH28 = 0x1c;
    public const ushort P91xx_CH29 = 0x1d;
    public const ushort P91xx_CH30 = 0x1e;
    public const ushort P91xx_CH31 = 0x1f;
	/*For PCIe-9163*/
    public const ushort P91xx_CH32 = 0x20;
    public const ushort P91xx_CH33 = 0x21;
    public const ushort P91xx_CH34 = 0x22;
    public const ushort P91xx_CH35 = 0x23;
    public const ushort P91xx_CH36 = 0x24;
    public const ushort P91xx_CH37 = 0x25;
    public const ushort P91xx_CH38 = 0x26;
    public const ushort P91xx_CH39 = 0x27;
    public const ushort P91xx_CH40 = 0x28;
    public const ushort P91xx_CH41 = 0x29;
    public const ushort P91xx_CH42 = 0x2a;
    public const ushort P91xx_CH43 = 0x2b;
    public const ushort P91xx_CH44 = 0x2c;
    public const ushort P91xx_CH45 = 0x2d;
    public const ushort P91xx_CH46 = 0x2e;
    public const ushort P91xx_CH47 = 0x2f;
    /*For PCIe-9164*/
    public const ushort P91xx_CH48 = 0x30;
    public const ushort P91xx_CH49 = 0x31;
    public const ushort P91xx_CH50 = 0x32;
    public const ushort P91xx_CH51 = 0x33;
    public const ushort P91xx_CH52 = 0x34;
    public const ushort P91xx_CH53 = 0x35;
    public const ushort P91xx_CH54 = 0x36;
    public const ushort P91xx_CH55 = 0x37;
    public const ushort P91xx_CH56 = 0x38;
    public const ushort P91xx_CH57 = 0x39;
    public const ushort P91xx_CH58 = 0x3a;
    public const ushort P91xx_CH59 = 0x3b;
    public const ushort P91xx_CH60 = 0x3c;
    public const ushort P91xx_CH61 = 0x3d;
    public const ushort P91xx_CH62 = 0x3e;
	public const ushort P91xx_CH63 = 0x3f;

    /*Timbase and conversion settings for AI*/
    public const ushort P91xx_AI_TIMEBASE_INT     = 0x00;
    public const ushort P91xx_AI_TIMEBASE_EXT     = 0x10;
    public const ushort P91xx_AI_CONVSRC_EXT      = 0x20;
    /*Trigger Mode*/
    public const ushort P91xx_AI_TRGMOD_POST      = 0x00;
    public const ushort P91xx_AI_TRGMOD_DELAY     = 0x02;
    public const ushort P91xx_AI_TRGMOD_PRE       = 0x04;
    public const ushort P91xx_AI_TRGMOD_MID       = 0x05;
    /*Trigger Source*/
    public const ushort P91xx_AI_TRGSRC_SOFT      = 0x00;
    public const ushort P91xx_AI_TRGSRC_EXTD      = 0x10;
    public const ushort P91xx_AI_TRGSRC_AI        = 0x20;
    /*Trigger Polarity*/
    public const ushort P91xx_AI_TrgPositive      = 0x000;
    public const ushort P91xx_AI_TrgNegative      = 0x100;
    /*Delay Trigger with Samples*/
    public const ushort P91xx_AI_DlyInTimebase    = 0x100;
    public const ushort P91xx_AI_DlyInSamples     = 0x200;    
    /*Analog Trigger condition constants*/
    public const ushort P91xx_Below_Low_level      = 0x00;
    public const ushort P91xx_Above_High_Level     = 0x10;
    public const ushort P91xx_Inside_Region        = 0x20;
    public const ushort P91xx_High_Hysteresis      = 0x30;
    public const ushort P91xx_Low_Hysteresis       = 0x40;
    /*ReTrigger*/
    public const ushort P91xx_AI_EnReTigger       = 0x200;

    /*------------------*/
    /* AO Constants     */
    /*------------------*/
    /*Timbase for AO*/
    public const ushort P91xx_AO_TIMEBASE_INT  = 0x00;
    public const ushort P91xx_AO_TIMEBASE_EXT  = 0x01;
    /*Trigger Mode*/
    public const ushort P91xx_AO_TRGMOD_POST   = 0x00;
    /*Trigger Source*/
    public const ushort P91xx_AO_TRGSRC_SOFT   = 0x00;
    public const ushort P91xx_AO_TRGSRC_EXTD   = 0x10;
    /*Trigger Polarity*/
    public const ushort P91xx_AO_TrgPositive   = 0x000;
    public const ushort P91xx_AO_TrgNegative   = 0x100;

    /*------------------*/
    /* DI Constants     */
    /*------------------*/
    /*Timbase and conversion settings for DI*/
    public const ushort P91xx_DI_TIMEBASE_INT   = 0x00;
    public const ushort P91xx_DI_TIMEBASE_EXT   = 0x01;
    public const ushort P91xx_DI_CONVSRC_SYNC_IN= 0x02;
    /*Trigger Mode*/
    public const ushort P91xx_DI_TRGMOD_POST    = 0x00;
    /*Trigger Source*/
    public const ushort P91xx_DI_TRGSRC_SOFT    = 0x00;
    public const ushort P91xx_DI_TRGSRC_EXTD    = 0x10;
    /*Trigger Polarity*/
    public const ushort P91xx_DI_TrgPositive    = 0x000;
    public const ushort P91xx_DI_TrgNegative    = 0x100;

    /*------------------*/
    /* DO Constants     */
    /*------------------*/
    /*Timbase for DO*/
    public const ushort P91xx_DO_TIMEBASE_INT   = 0x00;
    public const ushort P91xx_DO_TIMEBASE_EXT   = 0x01;
    /*Trigger Mode*/
    public const ushort P91xx_DO_TRGMOD_POST    = 0x00;
    /*Trigger Source*/
    public const ushort P91xx_DO_TRGSRC_SOFT    = 0x00;
    public const ushort P91xx_DO_TRGSRC_EXTD    = 0x10;
    /*Trigger Polarity*/
    public const ushort P91xx_DO_TrgPositive    = 0x000;
    public const ushort P91xx_DO_TrgNegative    = 0x100;
    /*Retrigger*/
    public const ushort P91xx_INFINITE_RETRIG   = 0x200;

    /*Encoder/GPTC Constants*/
    public const ushort P91xx_GPTC0   			= 0x00;
    public const ushort P91xx_GPTC1   			= 0x01;
	public const ushort P91xx_GPTC2   			= 0x02;
	public const ushort P91xx_GPTC3   			= 0x03;
	public const ushort P91xx_ENCODER0          = 0x04;
	public const ushort P91xx_ENCODER1          = 0x05;
	
	/*AI DMA with Encoder Feature*/
	public const ushort AI_DMA_ENCODER_MODE     = 0x10;
    /*------------------*/
    /* DIO Constants     */
    /*------------------*/
    public const ushort DIO_MODE_0   = 0;
    public const ushort DIO_MODE_1   = 1;
	public const ushort DIO_MODE_2   = 2;
	public const ushort DIO_MODE_3   = 3;
	
    /*--------------------------------------*/
    /* Pattern Match Control with Action    */
    /*--------------------------------------*/
    // Pattern Match Channel
    public const ushort PM_DI        =0;
    public const ushort PM_ENCODER0  =1;
    public const ushort PM_ENCODER1  =2;
    // Pattern Match Action
    public const ushort PM_ACTION_NO    = 0;
    public const ushort PM_ACTION_AO_POL =1;
    public const ushort PM_ACTION_AO_DMA =2;
    public const ushort PM_ACTION_DO_POL =3;
    public const ushort PM_ACTION_DO_DMA =4;
    // Pattern Match Control
    public const ushort PM_STOP  =0;
    public const ushort PM_START =1;
    public const ushort PM_CLEAR =2;
    // Pattern Match Counter Control
    public const ushort PM_COUNTER_READ =0;
    public const ushort PM_COUNTER_CLEAR =1;
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_Config (ushort CardNumber, ushort ConfigCtrl, ushort TrigCtrl, uint TriggerCnt, uint MidOrDlyScans,bool AutoResetBuf);
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_CounterInterval (ushort CardNumber, uint ScanIntrv, uint SampIntrv);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_AsyncReTrigNextReady (ushort CardNumber, out byte Ready, out byte StopFlag, out ushort RdyTrigCnt);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_ContReadChannel(ushort CardNumber, ushort Channel, ushort AdRange, ref ushort Buffer, uint ReadCount, double SampleRate, ushort SyncMode);
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_ContReadMultiChannels (ushort CardNumber, ushort NumChans, ushort[] Chans, ushort[] AdRanges, ref ushort Buffer, uint ReadCount, double SampleRate, ushort SyncMode);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_ContScanChannels (ushort CardNumber, ushort Channel, ushort AdRange, ref ushort Buffer, uint ReadCount, double SampleRate, ushort SyncMode);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_VoltScale32(ushort CardNumber, ushort AdRange, uint reading, out double voltage);
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_VReadChannel (ushort CardNumber, ushort Channel, ushort AdRange, out double voltage);
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_AnalogTrig_Config (ushort CardNumber, ushort TrigCtrl, ushort H_TrgLevel, ushort L_TrgLevel);
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_AnalogTrig_Config_ByVoltage (ushort CardNumber, ushort TrigCtrl, double H_TrgLevel_V, double L_TrgLevel_V, ushort adRange);
	[DllImport("PCI-Dask64.dll")]
	public static extern short AI_CH_Param_Config(ushort CardNumber, ushort Channel, ushort Param, ushort Value);    
/*---------------------------------------------------------------------------*/
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_relay_EN (ushort CardNumber, ushort enable);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_Config (ushort CardNumber, ushort ConfigCtrl, ushort TrigCtrl, uint TriggerCnt, bool AutoResetBuf);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_AsyncCheck (ushort CardNumber, out byte Stopped, out uint AccessCnt);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_AsyncDblBufferMode(ushort CardNumber, byte Enable);
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_AsyncDblBufferHalfReady (ushort CardNumber, out bool bHalfReady);
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_AsyncDblBufferHalfReady (ushort CardNumber, out byte bHalfReady);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_ContBufferSetup(ushort CardNumber, short[] Buffer, uint WriteCount, out ushort BufferId);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_WriteChannels(ushort CardNumber, ushort NumOfChannel, short Channel, short[] Buffer);
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_VWriteChannels(ushort CardNumber, ushort NumOfChannel, ushort[] Channel, double[] Buffer);		
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_AsyncReTrigNextReady(ushort CardNumber, out byte Ready, out byte StopFlag, out ushort RdyTrigCnt);
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short DI_Config (ushort CardNumber, ushort ConfigCtrl, ushort TrigCtrl, uint TriggerCnt, bool AutoResetBuf);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short DI_AsyncReTrigNextReady (ushort CardNumber, out byte Ready, out byte StopFlag, out ushort RdyTrigCnt);
    [DllImport("PCI-Dask64.dll")]
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short DO_Config (ushort CardNumber, ushort ConfigCtrl, ushort TrigCtrl, uint TriggerCnt, bool AutoResetBuf);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short DO_ContWritePort(ushort CardNumber, ushort Port, ref ushort BufferID, uint WriteCount, ushort Iterations, double SampleRate, ushort SyncMode);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short DO_AsyncDblBufferHalfReady(ushort CardNumber, out byte HalfReady);
    [DllImport("PCI-Dask64.dll")]
    public static extern short DO_AsyncDblBufferHalfReady(ushort CardNumber, out bool HalfReady);
    /*---------------------------------------------------------------------------*/
    [DllImport("PCI-Dask64.dll")]
    public static extern short DO_AsyncDblBufferMode(ushort CardNumber, byte enableDB);
    [DllImport("PCI-Dask64.dll")]
    public static extern short DO_AsyncReTrigNextReady(ushort CardNumber, out byte Ready, out byte StopFlag, out ushort RdyTrigCnt);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short DIO_Mode_Config(ushort CardNumber, ushort Mode);
/*---------------------------------------------------------------------------*/
    [DllImport("PCI-Dask64.dll")]
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short PCI_DB_Calibration_FactoryReset (ushort CardNumber);
    [DllImport("PCI-Dask64.dll")]
...
/*----------------------------------------------------------------------------*/
    [DllImport("PCI-Dask64.dll")]
    public static extern short SPI_Setup_SYNC (ushort CardNumber, ushort NumPorts, IntPtr SPI_Port, IntPtr SPI_Config, uint SPI_SetupValue1, IntPtr SPI_SetupValue2);
    [DllImport("PCI-Dask64.dll")]
    public static extern short SPI_Control_SYNC (ushort CardNumber, ushort NumPorts, IntPtr SPI_Port, IntPtr SPI_CtrlParam, IntPtr SPI_CtrlValue);
    [DllImport("PCI-Dask64.dll")]
    public static extern short SPI_Status_SYNC (ushort CardNumber, ushort NumPorts, IntPtr SPI_Port, IntPtr SPI_Status);
    [DllImport("PCI-Dask64.dll")]
    public static extern short SPI_Read_SYNC (ushort CardNumber, ushort NumPorts, IntPtr SPI_Port, IntPtr SPI_SlaveAddr, IntPtr SPI_CmdAddrBits, IntPtr SPI_DataBits, IntPtr SPI_FrontDummyBits, IntPtr SPI_CmdAddr, IntPtr SPI_Data);
    [DllImport("PCI-Dask64.dll")]
    public static extern short SPI_Write_SYNC (ushort CardNumber, ushort NumPorts, IntPtr SPI_Port, IntPtr SPI_SlaveAddr, IntPtr SPI_CmdAddrBits, IntPtr SPI_DataBits, IntPtr SPI_FrontDummyBits, IntPtr SPI_TailDummyBits, IntPtr SPI_CmdAddr, IntPtr SPI_Data);
/*----------------------------------------------------------------------------*/
    [DllImport("PCI-Dask64.dll")]
    public static extern short Parallel_Setup (ushort CardNumber, ushort Parallel_Port, uint Parallel_SetupValue1, uint Parallel_SetupValue2);
    [DllImport("PCI-Dask64.dll")]
    public static extern short Parallel_Control (ushort CardNumber, ushort Parallel_Port, ushort Parallel_CtrlParam, uint Parallel_CtrlValue);
	[DllImport("PCI-Dask64.dll")]
    public static extern short Parallel_Read (ushort CardNumber, ushort Parallel_Port, ushort Parallel_SlaveAddr, ushort Parallel_CmdAddrBits, ushort Parallel_DataBits, ushort Parallel_FrontDummyBits, uint Parallel_CmdAddr, out uint Parallel_Data);
/*----------------------------------------------------------------------------*/
    [DllImport("PCI-Dask64.dll")]
    public static extern short Parallel_Setup_SYNC (ushort CardNumber, ushort NumPorts, IntPtr Parallel_Port, IntPtr Parallel_Config, uint Parallel_SetupValue1, IntPtr Parallel_SetupValue2);
    [DllImport("PCI-Dask64.dll")]
    public static extern short Parallel_Control_SYNC (ushort CardNumber, ushort NumPorts, IntPtr Parallel_Port, IntPtr Parallel_CtrlParam, IntPtr Parallel_CtrlValue);
	[DllImport("PCI-Dask64.dll")]
    public static extern short Parallel_Read_SYNC (ushort CardNumber, ushort NumPorts, IntPtr Parallel_Port, IntPtr Parallel_SlaveAddr, IntPtr Parallel_CmdAddrBits, IntPtr Parallel_DataBits, IntPtr Parallel_FrontDummyBits, IntPtr Parallel_CmdAddr, IntPtr Parallel_Data);
/*----------------------------------------------------------------------------*/
    [DllImport("PCI-Dask64.dll")]
    public static extern short Get_PLL_Lock_Status (ushort CardNumber, IntPtr dwValue);
	[DllImport("PCI-Dask64.dll")]
	public static extern short AI_Set_Sampling_Mode (ushort CardNumber, uint  dwValue);
	[DllImport("PCI-Dask64.dll")]
	public static extern short AI_Get_Sampling_Mode (ushort CardNumber, IntPtr dwValue);
/*----------------------------------------------------------------------------*/
    [DllImport("PCI-Dask64.dll")]
    public static extern short PM_Setup (ushort CardNumber, ushort wType, ushort wAction, ushort wNumOfPattern, uint[] dwPatternArray);
    [DllImport("PCI-Dask64.dll")]
    public static extern short PM_Control (ushort CardNumber, ushort wType, ushort wMode);
    [DllImport("PCI-Dask64.dll")]
    public static extern short PM_Counter (ushort CardNumber, ushort wType, ushort wMode, out uint dwValueHigh, out uint dwValueLow);
    [DllImport("PCI-Dask64.dll")]
    public static extern short PM_EventCallBack_x64(ushort CardNumber, short mode, ushort EventType, MulticastDelegate callbackAddr);
/*----------------------------------------------------------------------------*/
}
