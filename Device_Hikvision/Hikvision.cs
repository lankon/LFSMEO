...
namespace Device_Hikvision
{
    public class Hikvision: ICamera
    {
        ...
        public int Connect()
        {
            ...
            nRet = MV_CC_EnumDevices_NET(MV_GIGE_DEVICE, ref MV_INFO_LIST);
            ...
            for (int i=0; i< MV_INFO_LIST.nDeviceNum; i++)
            {
                ...
                nRet = m_pOperator[i].SetIntValue("GevSCPD", 0);
                ...
                nRet = m_pOperator[i].SetEnumValue("BalanceWhiteAuto", (uint)MV_CAM_BALANCEWHITE_AUTO.MV_BALANCEWHITE_AUTO_OFF);//0：Off 
