...
namespace ProbeTester.Logic
{
    ...
    {
        public MainTask(IServiceProvider serviceProvider, IProbeTesterMachine ProbeTesterMachine, IF_StateControl f_StateControl)
        {
            Machine = ProbeTesterMachine;
        ...
        private IProbeTesterMachine Machine;
