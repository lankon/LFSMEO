...
namespace RGBTester.Logic
{
    ...
    {
        public MainTask(IRGBTesterMachine rGBTesterMachine, IF_StateControl f_StateControl)
        {
        ...
        public void SetTask<T>(string method = "Default") where T : IF_BaseTask
        {
            ...
            BaseTask = (IF_BaseTask)Activator.CreateInstance(typeof(T), method);
        }
