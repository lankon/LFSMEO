...
namespace DETester.Logic
{
    public class F_MainFormLogic
    {
        public F_MainFormLogic(IDETesterMachine probeTesterMachine , IServiceProvider serviceProvider)
        {
        ...
        IDETesterMachine ProbeTesterMachine;
        ...
        private void Initial_IO_Function()
        {
            ...
            ProbeTesterMachine.DIOL.Initial_All_IO();
        }
        ...
        public void CreateFolder()
        {
            ...
            Tool.CreateFolder(AppPath + @"\Temp");
            Tool.CreateFolder(AppPath + @"\History");
            Tool.CreateFolder(AppPath + @"\Picture");
            Tool.CreateFolder(AppPath + @"\Result");
            Tool.CreateFolder(AppPath + @"\Setting");
            Tool.CreateFolder(AppPath + @"\Backup");
            Tool.CreateFolder(AppPath + @"\Setting\Package");
