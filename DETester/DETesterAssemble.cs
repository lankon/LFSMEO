...
using DETester.Base;
using DETester.UI;
using DETester.Logic;

namespace DETester
{
    public static class DETesterAssemble
    {
        public static IServiceCollection AddDETesterServices(this IServiceCollection services)
        {
            //[DETesterMachine]
            services.AddSingleton<IDETesterMachine, DETesterMachine>();
