...
namespace AAMachine
{
    public static class AAMachineAssemble
    {
        public static IServiceCollection AddAAMachineServices(this IServiceCollection services)
        {
            //[AAMachineMachine]
            services.AddSingleton<IAAMachineMachine, AAMachineMachine>();
